                                    ...
                                    <Col lg={9}>
                                        <div>
                                            <div className="text-center">
                                                ...
                                                <p className="text-muted">Sign in to continue to International Affairs Office.</p>
                                            </div>
                                            ...
                                            <div className="mt-5 text-center">
                                                ...
                                                <p>© 2021 International Affairs Office. Crafted with <i className="mdi mdi-heart text-danger"></i> by BSc CME and CMS</p>
                                            </div>
                                        </div>
